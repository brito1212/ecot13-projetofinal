...
public class AtiradorAltera extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AtiradorAltera frame = new AtiradorAltera();
	...
	public AtiradorAltera() {
		...
		btnSalvar.setBounds(31, 253, 89, 23);
